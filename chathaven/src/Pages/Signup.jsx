...
export const Signup = () => {
    let handleSignUpWithGoogle = async (event) => {
        // code logic to implement login with Google.
        ...
        try {
            // Sign out the current user before proceeding
            await signOut(auth); // sign out user before continuing
        ...
        <div className="bg-[#0e0e0e] flex flex-row justify-center w-full">
            <div className="bg-[#0e0e0e] overflow-hidden w-[1440px] h-[1024px]">
                <div className="relative w-[1387px] h-[936px] top-[60px] left-[60px]">
                            ...
                            <div className="inline-flex flex-col items-center gap-[53px] relative top-[97px] left-10">
                                <div className="inline-flex flex-col items-start gap-4 relative flex-[0_0_auto]">
                                    <div className="inline-flex flex-col items-start gap-3.5 relative flex-[0_0_auto]">
                                        ...
                                        <div
                                            className="inline-flex flex-col items-start gap-[25px] relative flex-[0_0_auto]">
                                            <input
                                            ...
                                            <div
                                                className="inline-flex flex-col items-center justify-center gap-3 relative flex-[0_0_auto]">
                                                <div
                                                    className="flex w-[400px] items-center justify-center gap-2.5 px-2.5 py-3.5 rounded-xl [background:linear-gradient(180deg,rgb(45.62,76.4,238)_0%,rgb(33.5,30.28,191.25)_53.12%,rgb(3.9,15.19,116.88)_100%)] relative flex-[0_0_auto]">
                                                    <button
                    ...
                    <img
                        className="absolute w-[575px] h-0.5 top-[488px] left-64"
                        alt="Line"
                        src={line3}
                    />
                </div>
